...
public partial class Script_SpriteStudio6_Root :  Library_SpriteStudio6.Script.Root
{
	...
	internal void StartMain()
	{
        ...
        {
            Debug.Log("[SS6] InformationCheckPlay false!");
            goto StartMain_ErrorEnd;
		}
        ...
        {
            Debug.Log("[SS6] ControlBootUpParts false!");
            goto StartMain_ErrorEnd;
		}
        ...
        {
            Debug.Log("[SS6] ChainDrawBootUp() false!");
            goto StartMain_ErrorEnd;
		}
        ...
        {
            Debug.Log("[SS6] ClusterBootUpDraw() false!");
            goto StartMain_ErrorEnd;
		}
        ...
        {
            Debug.Log("[SS6] AnimationPlayInitial() false!");
            goto StartMain_ErrorEnd;
		}
		return;
...
//	}
	...
	private bool ControlBootUpParts(int countPartsSprite)
	{
        ...
        {
            Debug.Log("[SS6] null == TableControlParts false!");
        ...
        {
            Debug.Log("[SS6] TableControlParts.Length false!");
            goto ControlBootUpParts_ErrorEnd;
		}
		...
		for(int i=0; i<countParts; i++)
		{
            ...
            {
                Debug.Log($"[SS6] TableControlParts[{i}].BootUp false!");
                goto ControlBootUpParts_ErrorEnd;
			}
		}
